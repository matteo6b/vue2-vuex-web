...
export default {
  ...
  get(id, params, cb, errCb) {
    axios.get(`api/v1/like/ ${id}`, params)
    .then(res => cb(res)).catch(error => errCb(error));
  },

  create(params, cb, errCb) {
    axios.post('api/v1/like', params).then(res => cb(res)).catch(error => errCb(error));
  },

  update(id, params, cb, errCb) {
    axios.put(`api/v1/like/ ${id}`, params).then(res => cb(res)).catch(error => errCb(error));
  },

  remove(id, cb, errCb) {
    axios.delete(`api/v1/like/ ${id}`).then(res => cb(res)).catch(error => errCb(error));
  },
};
